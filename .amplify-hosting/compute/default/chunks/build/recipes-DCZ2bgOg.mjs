...
const _sfc_main = {
  ...
  setup(__props) {
    useSeoMeta({
      ...
      description: "Explore traditional Portuguese recipes like Bacalhau, Past\xE9is de Nata, and Caldo Verde. Learn cooking vocabulary and cultural insights with each dish.",
    ...
    const recipes = [
      ...
      {
        id: 6,
        title: "Ameijoas \xE0 Bulh\xE3o Pato",
...
//# sourceMappingURL=recipes-DCZ2bgOg.mjs.map
