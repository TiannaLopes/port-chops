...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const resources = [
      ...
      {
        category: "Books",
        title: "O Pr\xEDncipe com Orelhas de Burro",
      ...
      },
      {
        ...
        description: "Jos\xE9 Saramago's masterpiece about 18th century Portugal. For advanced learners.",
        level: "Advanced",
      ...
      // Music
      {
        category: "Music",
        title: "Fado Playlist",
        description: "Traditional Portuguese music genre. Listen to Am\xE1lia Rodrigues, Mariza, and modern fado artists.",
        level: "All Levels",
...
//# sourceMappingURL=media-ebG_9M7G.mjs.map
