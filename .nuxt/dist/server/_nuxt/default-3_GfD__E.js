import { _ as __nuxt_component_0 } from "./nuxt-link-DATV2KkI.js";
import { ref, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext, unref } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrRenderTeleport, ssrRenderAttr, ssrRenderSlot } from "vue/server-renderer";
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li><a href="#newsletter" class="text-breezeway-200 hover:text-white transition-colors"> Newsletter </a></li></ul></div></div><div class="border-t border-breezeway-800 mt-8 pt-8 text-center text-breezeway-300"><p>© ${ssrInterpolate(unref(currentYear))} Port-Chops. All rights reserved.</p></div></div></footer>`);
    };
  }
};
...
//# sourceMappingURL=default-3_GfD__E.js.map
